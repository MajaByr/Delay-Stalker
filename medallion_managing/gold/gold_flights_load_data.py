...
df_flights = (
    df_flights_csv.withColumnRenamed("origin_airport", "origin_airport_iata_code")
    .withColumnRenamed("destination_airport", "destination_airport_iata_code")
