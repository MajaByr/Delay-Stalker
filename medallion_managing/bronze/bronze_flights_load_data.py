...
df_airlines.write.mode("append").saveAsTable("flights_bronze.airlines")
...
df_airports.write.mode("append").saveAsTable("flights_bronze.airports")
...
df_flights = spark.read.format("csv") \
    ...
    .load("/Volumes/workspace/flightsschema/flightsvolume/flights.csv")

df_flights.write.mode("append").saveAsTable("flights_bronze.flights")
